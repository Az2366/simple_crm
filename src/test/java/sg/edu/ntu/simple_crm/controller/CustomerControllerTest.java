...
public class CustomerControllerTest {
        ...
        public void testGetAllCustomers() throws Exception {
                ...
                mockMvc.perform(request)
                                ...
                                // Assert that the content type is JSON
                                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                                // Assert that the first customer's id is 1
        ...
        public void testValidCustomerCreation() throws Exception {
                ...
                mockMvc.perform(request)
                                ...
                                // Assert that the content type is JSON
                                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                                // Assert that the id returned is 5
        ...
        public void testInvalidCustomerCreation() throws Exception {
                ...
                Customer invalidCustomer = new Customer(3L, "", "Banner", "bruce@a.com", "12345678", "Manager", 1990,
                                null);
